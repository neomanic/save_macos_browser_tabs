(*
Export All Browser Tabs in All Open Windows to a Markdown File
April 21, 2022
...
// FUNCTIONAL CHANGES COMPARED TO THE ORIGINAL SCRIPT
...
set NoteTitle to "# " & browser_name & " Tabs " & the date_stamp
...
set save_Filename to browser_name & " Tabs " & todayDate & ".md"
